...
public class _1992Test {
    ...
    void findFarmland() {
        ...
        assertThat(task.findFarmland(new int[][]{{0,1},{1,0}})).isEqualTo(new int[][]{{0,1,0,1},{1,0,1,0}});
        assertThat(task.findFarmland(new int[][]{{1,1},{0,0}})).isEqualTo(new int[][]{{0,0,0,0},{0,1,0,1}});
